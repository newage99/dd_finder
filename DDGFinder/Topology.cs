...
namespace DDGFinder
{
    class Topology
    {
        ...
        public int tries = 0;
        public double populateAndIdSettedTime = 0D;
        ...
        public string DegreeDiameterAndSecondPuntuation
        {
            get { return degree.ToString() + " " + diameter.ToString() + " " + SecondPuntuation.ToString(); }
        }
